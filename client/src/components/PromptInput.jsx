...
//       <form
//         onSubmit={handleSubmit}
//         className="w-full bg-white/10 backdrop-blur-xl rounded-xl ring-1 ring-white/25 focus-within:ring-2 focus-within:ring-white/30 overflow-hidden transition"
//       >
//         <textarea
//           ref={textareaRef}
//           value={value}
...
//         type="submit"
//         disabled={!value.trim() || loading}
//         className="inline-flex items-center justify-center bg-zinc-950 text-white hover:bg-zinc-800 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer rounded-full shrink-0"
//         style={{
//           width: large ? 36 : 24,
//           height: large ? 36 : 24,
//         }}
