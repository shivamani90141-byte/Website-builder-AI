...
//watches for files edits inside Sandpack editor and save changes to dB & live state
...
//         const previousCode =
//           typeof prev[path] === "string" ? prev[path] : prev[path]?.content;
