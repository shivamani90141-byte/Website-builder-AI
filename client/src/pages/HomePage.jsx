      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-20 mt-8 xl:mt-28">
        <div className="w-full max-w-2xl flex flex-col items-center">
          ...
          <p className="text-center text-sm md:text-base max-w-xl mt-4  text-white/65 leading-relaxed">
            Turn your idea into a stunning website with AI design, build, and
            launch without writing a single line of code.
          </p>

          {/*Promt input with glassmorphic varient */}
            ...
            <div className=" mt-12 w-full ">
              ...
              <div className="space-y-2 max-h-[80vh] overflow-y-auto pr-1">
                {projects.map((p) => (
                  <div
                    key={p._id}
                    className="bg-white/5 border border-white/10 rounded-lg px-4 py-3 flex items-center justify-between group hover:bg-white/20 hover:bg-white/10 cursor-pointer backdrop-blur-md transition-all"
